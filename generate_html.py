...
function uploadFile(file) {{
    ...
    var fd = new FormData();
    fd.append('file', file);
    fetch('/api/datasets/upload', {{ method: 'POST', body: fd }})
...
function analyzeUrl() {{
    ...
    fetch('/api/datasets/analyze-url', {{ method: 'POST', headers: {{'Content-Type': 'application/json'}}, body: JSON.stringify({{url: url}}) }})
        .then(function(r) {{ return r.json(); }})
        .then(function(data) {{
            if (data.error) {{ ct.innerHTML = '<div class="analysis-card"><h3>Error</h3><p>' + data.error + '</p></div>'; return; }}
            _pendingAnalysis = data;
...
function searchDatabases() {{
    ...
    fetch('/api/datasets/search', {{ method: 'POST', headers: {{'Content-Type': 'application/json'}}, body: JSON.stringify({{query: q}}) }})
        .then(function(r) {{ return r.json(); }})
        .then(function(data) {{
            if (data.error) {{ ct.innerHTML = '<div class="analysis-card"><h3>Error</h3><p>' + data.error + '</p></div>'; return; }}
...
function doImport() {{
    ...
    fetch('/api/datasets/import', {{ method: 'POST', headers: {{'Content-Type': 'application/json'}}, body: JSON.stringify(body) }})
        .then(function(r) {{ return r.json(); }})
        .then(function(data) {{
