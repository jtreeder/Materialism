...
# Build per-dataset structure for JS — only include active datasets (same set as per_dataset_data)
# so the search page and database page always reference the exact same dataset list.
