...
function renderDetail() {{
    ...
    for (var i = 0; i < limit; i++) {{
        ...
        html += '<td style="text-align:center;padding:0 4px"><input type="checkbox"' + (rChecked ? ' checked' : '') + ' data-excl-key="' + _exclKey + '" onchange="_toggleExclusion(\\x27' + itemType + '\\x27,\\x27' + dsId + '\\x27,' + JSON.stringify(rName) + ',this);this.closest(\\x27tr\\x27).style.opacity=this.checked?\\x271\\x27:\\x270.45\\x27"></td>';
